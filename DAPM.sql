...
-- Ràng buộc
--1. Thêm ràng buộc CHECK cho cột trạng thái trong bảng lịch sử trạng thái
ALTER TABLE LichSuTrangThai
ADD CONSTRAINT CHK_TrangThai CHECK (TrangThai IN (
    N'Chờ xác nhận',
    N'Đã xác nhận',
    N'Đang thực hiện',
    N'Hoàn thành',
...
-- Thêm ràng buộc CHECK cho cột trạng thái trong bảng ngày làm việc
...
-- Thêm ràng buộc CHECK cho cột trạng thái trong bảng dịch vụ
ALTER TABLE DichVu
...
-- Thêm ràng buộc CHECK cho cột trạng thái trong bảng khiếu nại
...
-- Thêm ràng buộc CHECK cho cột trạng thái trong bảng hồ sơ
ALTER TABLE HoSo
ADD CONSTRAINT CHK_TrangThaiHoSo CHECK (TrangThai IN (
    N'Chờ duyệt',
    N'Đã duyệt',
    N'Từ chối'
));
