...
export default function TaiKhoanPage() {
  ...
  return (
    <div className="p-8 max-w-lg mx-auto">
      <div className="mb-7">
        <h1 className="text-[28px] font-bold text-slate-800 leading-tight">Tài khoản</h1>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mb-4">
        ...
        <div className="bg-gradient-to-br from-indigo-500 via-indigo-600 to-purple-600 px-6 py-8 flex items-center gap-5">
          ...
          <div>
            ...
            <p className="text-[12.5px] text-white/70 mt-1">{user?.email ?? ""}</p>
        ...
        <div className="px-6 py-2">
          {loading ? (
            <div className="py-10 flex flex-col items-center gap-3">
              ...
              <p className="text-[13px] text-slate-400">Đang tải thông tin...</p>
            </div>
          ) : (
            <>
              <InfoItem
