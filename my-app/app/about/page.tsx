            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
              ...
              >
                ...
                <p className="text-stone-600 text-lg sm:text-xl leading-relaxed mb-8">
                  Homezy ra đời với niềm tin mãnh liệt: Việc nhà không nên là
                  gánh nặng đánh cắp thời gian của những gia đình hiện đại, và
                  nghề giúp việc cần được tôn vinh như một nghề nghiệp chuyên
                  nghiệp.
                </p>
            ...
            >
              ...
              <div className="text-stone-600 text-lg leading-relaxed space-y-6">
                <p>
                  ...
                  khỏi những công việc nhà không tên. Để sau một ngày dài làm
                  việc căng thẳng, khi mở cửa bước vào, thứ đón chờ bạn là một
                  ngôi nhà sạch sẽ, thơm tho và mâm cơm ấm cúng. Thời gian của
                  bạn xứng đáng được dành cho việc nghỉ ngơi và những người thân
                  yêu.
                </p>
                <p>
                  Đối với <strong>người lao động</strong>, chúng tôi mang đến
                  hàng ngàn cơ hội việc làm minh bạch, thu nhập ổn định và môi
                  trường làm việc được tôn trọng. Chúng tôi đào tạo kỹ năng,
                  trang bị bảo hiểm và ứng dụng công nghệ để giúp các cô, các
                  chị tự hào về nghề nghiệp của mình.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-stone-500 text-lg max-w-2xl mx-auto">
                Những nguyên tắc định hình nên mọi quyết định và hành động của
                đội ngũ GiúpViệc Pro.
              </p>
            </motion.div>
